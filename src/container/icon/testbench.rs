...
fn render_icon_test() {
    ...
    let mut strings = vec![
        ...
        String::from("`[[icon=github, size = 32]]`: [[icon=github, size = 32]] (default size)\n\n"),
        ...
        String::from("`[[brown]]      [[icon=github]]      [[/brown]]`: [[brown]][[icon=github]][[/brown]]\n\n"),
        ...
        String::from("`[[slateblue]]  [[icon=github]]  [[/slateblue]]`: [[slateblue]][[icon=github]][[/slateblue]]\n\n"),
        String::from("`[[turquoise]]  [[icon=github]]  [[/turquoise]]`: [[turquoise]][[icon=github]][[/turquoise]]\n\n"),
        String::from("`[[seagreen]]   [[icon=github]]   [[/seagreen]]`: [[seagreen]][[icon=github]][[/seagreen]]\n\n"),
